...
=====================
Introduction to Supersport
=====================

Supersport boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
Supersport's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

Supersport is perfect if you want a simple, smart, and flexible theme starter.
...
Supersport utilizes SASS for adaptive grids and layouts and general structure of the
...
Supersport is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'supersport' to another name like 'mytheme'. You're also welcome to keep
'supersport'.

1. DRUSH: The provided drush install script will duplicate the supersport theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and enable the supersport theme: $ drush en supersport
  - Set the theme as default $ drush config-set system.theme default supersport
    or copy the includes/supersport.drush.inc into your .drush folder.
  - Run the provided drush install script: $ drush supersport-install
  ...
  - At this time, you can uninstall supersport: $drush pmu supersport
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename supersport.info.yml to mytheme.info.yml
  - edit supersport.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'supersport' to 'mytheme'
  - Rename supersport.libraries.yml to mytheme.libraries.yml
  - Rename supersport.theme to mytheme.theme
  - in supersport.theme, change each instance of 'supersport' to 'mytheme'
  - Rename config/schema/supersport.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.supersport_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'supersport' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'supersport' to 'mytheme'
  - In theme-settings.php, change each instance of 'supersport' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'supersport' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'supersport' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'supersport' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'supersport' in every file in the theme.
    Most of Supersport's dependencies use the word 'supersport' somewhere and renaming
    these instances will cause Supersport to break in unpredictable ways.
  ...
  - If you don't bother renaming Supersport in the above locations, be advised that
    you will run into conflicts with other versions of Supersport on your site. If
    your site uses more than one theme based on Supersport, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in Supersport
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with Supersport" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in supersport.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in Supersport is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in Supersport, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with Supersport
===========================
...
Once Node.JS is installed, go to the root folder of Supersport and install your Grunt
packages:
...
Once installed, cd to the root folder of Supersport and run Grunt via the command
line:
...
Once you start using Supersport, you will massively change it until you reach the
point where it has nothing to do with Supersport anymore. Unlike Zen, Supersport is not
...
version of Supersport comes out. Always see Supersport as a STARTER, and as soon as you
start using it, it is not Supersport anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when Supersport
has a new version by the update module, simply delete "project = "supersport" in
supersport.info.yml.
...
Thanks for using Supersport, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/supersport
